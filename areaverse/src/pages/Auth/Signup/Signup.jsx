                ...
                user ?
                    ...
                    <div className="auth-card">
                        <div className="auth-form-content">
                            <form id="signup-form" className="form-content" >
                                {
                                    signUpStep === 1 ?
                                        <div className="signup-step-section">
                                            <div className="input-group">
                                                ...
                                                <span id="signup-username-error" className="error-message"></span>
                                            </div>
                                            <div className="input-group">
                                                    ...
                                                    formData.userPassword.length > 0 ?
                                                        <div className="password-strength-container">
                                                            <div className="password-strength-meter">
                                                                <div id="password-strength-bar" className="password-strength-bar"></div>
                                                            </div>
                                                            <div id="password-strength-text" className="password-strength-text"></div>
                                                        </div> :
                                                        <></>
                                                }
                                                <span id="signup-password-error" className="error-message"></span>
                                            </div>
                                            <div className="input-group">
                                                ...
                                                <span id="confirm-password-error" className="error-message"></span>
                                            </div>
                                            <button type="button" className="submit-btn" id="next-step-btn" onClick={(evt) => toggleSignUpStep(evt, 2)}>Next</button>
                                        </div> :
                                        <div className="signup-step-section">
                                            <div className="input-group">
                                                ...
                                                <span id="signup-firstname-error" className="error-message"></span>
                                            </div>
                                            <div className="input-group">
                                            ...
                                            <div className="input-group">
                                                ...
                                                <span id="signup-state-error" className="error-message"></span>
                                            </div>
                                            <div className="input-group">
                                                <label htmlFor="signup-areaname">Area Name</label>
